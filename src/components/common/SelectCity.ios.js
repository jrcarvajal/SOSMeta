...
const SelectCity = ({ main }) => {
  ...
  const changeOption = (evt) => {
    /*if (evt.id === cityId && route.name !== 'List') {
      changeSearch('');
      navigation.navigate('List');
      return null;
    }*/
    changeCity(evt.id, evt.name);
    ...
    <View style={styles.select}>
      {main && (
        <View style={[styles.shadow]}>
          <Animated.ScrollView
            ...
            style={[styles.options, animatedStyles, styles.toUp]}>
            {isLoading && (
      ...
      {!main && (
        <View style={[styles.shadow]}>
          <Animated.ScrollView
            keyboardShouldPersistTaps="always"
            style={[styles.options, animatedStyles, styles.toDown]}>
            {isLoading && (
              <View style={styles.loadingContainer}>
                <Text styles={styles.loading}>Cargando</Text>
              </View>
